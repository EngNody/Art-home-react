  ...
  return (
    ...
    <title>Personal Care</title>
                  ...
                  <div className="wrapper">
                    <div className="breadcrumb">
                      <ul className="flexitem">
                        <li><a href="#&quot;">Home</a></li>
                        <li><a href="#&quot;">Personal Care</a></li>
                        <li>Personal Care Slip On Personal Care Casual with Arch Support Insoles</li>
                      </ul>
                    </div>
                              ...
                              <div className="big-image">
                                <div className="big-image-wrapper swiper-wrapper">
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/personal care.jpg"><img src="images/personal care.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/personal care1.jpg"><img src="images/personal care1.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/personal care2.jpg"><img src="images/personal care2.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/personal care3.jpg"><img src="images/personal care3.jpg" alt="" /></a>
                                  </div>
                                </div>
                              ...
                              <div thumbslider className="small-image">
                                <ul className="small-image-wrapper flexitem swiper-wrapper">
                                  <li className="thumbnail-show swiper-slide">
                                    ...
                                    <img src="images/personal care1.jpg" alt="" />
                                  </li><li>
                                  </li><li className="thumbnail-show swiper-slide">
                                    <img src="images/personal care2.jpg" alt="" />
                                  </li><li>
          ...
          <li/> */}
                                    ...
                                    <img src="images/personal care3.jpg" alt="" />
                                  </li><li>
                                    <ul>
                                    </ul></li></ul></div>
                            </div>
                              ...
                              <div style={{height: 0}}>
                                <div style={{height: 0}}>
                                  <a href="#" style={{height: 0}}>
                                    <img src="images/personal care4.jpg" alt="" width={0} height={0} />
                                  </a>
                                </div>
                              </div>
                              <h3 className="ourname" style={{fontSize: '30px'}}>Personal Care Slip On Personal Care Casual with Arch Support Insoles</h3><br />
                              <div className="content">
                      ...
                      <div className="products main flexwrap keybuy">
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/personal care5.jpg" alt="" />
                              </a></div>
                ...
                <li>07</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/personal care6.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><div className="hana"><span className="icon-heart ri-heart-line" /></div></li>
      ...
      <li>Fashion Personality</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/personal care7.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><div className="hana"><span className="icon-heart ri-heart-line" /></div></li>
      ...
      <li>Fashion Personality</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/personal care8.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><div className="hana"><span className="icon-heart ri-heart-line" /></div></li>
      ...
      <li>Fashion Personality</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/personal care9.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><div className="hana"><span className="icon-heart ri-heart-line" /></div></li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/personal care10.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><div className="hana"><span className="icon-heart ri-heart-line" /></div></li>
