  ...
  return (
    ...
    <title>Accessories</title>
                  ...
                  <div className="wrapper flexitem responsive1">
                    <div className="left">
                      <ul className="flexitem main-links">
                        ...
                        <li><a href="../../wishlistpage.html">Wishlist</a></li>
                      </ul>
                    </div>
                    <div className="right">
                                  ...
                                  <div className="row">
                                    <div className="media">
                                      <div className="thumbnail object-cover">
                                        <a href>
                                          <img src="images/access2.webp" alt="" />
                                        </a>
                                      </div>
                                    </div>
                        ...
                        <div className="dpt-cat">
                          ...
                          <div className="dpt-menu">
                            <ul className="second-links">
                              ...
                              <li><a href="#">
                                  <div className="icon-large"><span className="icon-user" /></div>
                                  Boy's fashion
                                </a></li>
                              <li><a href="#">
                  ...
                  <div className="wrapper">
                    <div className="breadcrumb">
                      <ul className="flexitem">
                        <li><a href="#&quot;">Home</a></li>
                        <li><a href="#&quot;">Accessories</a></li>
                        <li>Accessories Make You a Unique Bride </li>
                      </ul>
                    </div>
                              ...
                              <div className="big-image">
                                <div className="big-image-wrapper swiper-wrapper">
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/access12.jpg"><img src="images/access12.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/access1.jpg"><img src="images/access1.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/access1.webp"><img src="images/access1.webp" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/access10.jpg"><img src="images/access10.jpg" alt="" /></a>
                                  </div>
                                </div>
                              ...
                              <div thumbslider className="small-image">
                                <ul className="small-image-wrapper flexitem swiper-wrapper">
                                  <li className="thumbnail-show swiper-slide">
                                    <img src="images/access12.jpg" alt="" />
                                  </li><li>
                                  </li><li className="thumbnail-show swiper-slide">
                                    <img src="images/access1.jpg" alt="" />
                                  </li><li>
                                  </li><li className="thumbnail-show swiper-slide">
                                    <img src="images/access1.webp" alt="" />
                                  </li><li>
          ...
          <li/> */}
                                    ...
                                    <img src="images/access10.jpg" alt="" />
                                  </li><li>
                                    <ul>
                                    </ul></li></ul></div>
                            </div>
                              ...
                              <div style={{height: 0}}>
                                <div style={{height: 0}}>
                                  <a href="#" style={{height: 0}}>
                                    <img src="images/access13.jpg" alt="" width={0} height={0} />
                                  </a>
                                </div>
                              </div>
                              <h3 className="ourname" style={{fontSize: '30px'}}>Accessories Make You a Unique Bride</h3><br />
                              <div className="content">
                                  ...
                                  <ul>
                                    <li className="has-child expand">
                                      ...
                                      <ul className="content">
                                        <li><span>Brands</span><span>Jewelry</span></li>
                                        <li><span>Activity</span>beauty</li>
                                        <li><span>Material</span><span>fleece</span></li>
                                        <li><span>Gender</span><span>Women</span></li>
                                      </ul>
                                    </li>
                      ...
                      <div className="products main flexwrap keybuy">
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/access14.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><a href="#"><i className="ri-heart-line" /></a></li>
                ...
                <li>07</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/access15.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><a href="#"><i className="ri-heart-line" /></a></li>
      ...
      <li>Fashion Personality</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/access16.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><a href="#"><i className="ri-heart-line" /></a></li>
                          ...
                          <div className="content">
                            ...
                            <h3 className="main-links">
                              <a href="#">Under Armour girls's Tech</a></h3>
                            <div className="rating">
                              <div className="stars" />
                              <span className="mini-text">(2,548)</span>
                            </div>
      ...
      <li>Fashion Personality</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/access17.png" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><a href="#"><i className="ri-heart-line" /></a></li>
      ...
      <li>Fashion Personality</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/access18.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><a href="#"><i className="ri-heart-line" /></a></li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/access19.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><a href="#"><i className="ri-heart-line" /></a></li>
                          ...
                          <div className="content">
                            <h3 className="main-links">
                              <a href="#">Sandal Womens Go Joy </a></h3>
                            <div className="rating">
                              <div className="stars" />
                              <span className="mini-text">(2,548)</span>
                            </div>
