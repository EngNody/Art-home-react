...
const Shaving = () => {
  return (
    <>
    <Helmet>
    <title>Shave & Hair Removal</title>
    </Helmet>
                  ...
                  <div className="wrapper">
                    <div className="breadcrumb">
                      <ul className="flexitem">
                        ...
                        <li>Shaving Slip On Shaving Casual with Arch Support Insoles</li>
                      </ul>
                    </div>
                              ...
                              <div className="big-image">
                                <div className="big-image-wrapper swiper-wrapper">
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/shaving1.jpg"><img src="images/shaving1.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/shaving2.jpg"><img src="images/shaving2.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/shaving3.jpg"><img src="images/shaving3.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/shaving4.jpg"><img src="images/shaving4.jpg" alt="" /></a>
                                  </div>
                                </div>
                              ...
                              <div thumbslider className="small-image">
                                <ul className="small-image-wrapper flexitem swiper-wrapper">
                                  <li className="thumbnail-show swiper-slide">
                                    <img src="images/shaving1.jpg" alt="" />
                                  </li><li>
                                  </li><li className="thumbnail-show swiper-slide">
                                    <img src="images/shaving2.jpg" alt="" />
                                  </li><li>
                                  </li><li className="thumbnail-show swiper-slide">
                                    <img src="images/shaving3.jpg" alt="" />
                                  </li><li>
          ...
          <li/> */}
                                    ...
                                    <img src="images/shaving4.jpg" alt="" />
                                  </li><li>
                                    <ul>
                                    </ul></li></ul></div>
                            </div>
                              ...
                              <div style={{height: 0}}>
                                <div style={{height: 0}}>
                                  <a href="#" style={{height: 0}}>
                                    <img src="images/shaving5.jpg" alt="" width={0} height={0} />
                                  </a>
                                </div>
                              </div>
                              <h3 className="ourname" style={{fontSize: '30px'}}>Men Slip On Shaving Casual with Arch Support Insoles</h3><br />
                              <div className="content">
                      ...
                      <div className="products main flexwrap keybuy">
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/shaving11.jpg" alt="" />
                              </a></div>
                ...
                <li>07</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/shaving7.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><div className="hana"><span className="icon-heart ri-heart-line" /></div></li>
      ...
      <li>Fashion Personality</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/shaving8.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><div className="hana"><span className="icon-heart ri-heart-line" /></div></li>
      ...
      <li>Fashion Personality</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/shaving9.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><div className="hana"><span className="icon-heart ri-heart-line" /></div></li>
      ...
      <li>Fashion Personality</li>
                        ...
                        <div className="item">
                          <div className="media">
                            <div className="thumbnail object-cover">
                              <a href="#">
                                <img src="images/shaving10.jpg" alt="" />
                              </a></div>
                            <div className="hoverable">
                              <ul>
                                <li className="active"><div className="hana"><span className="icon-heart ri-heart-line" /></div></li>
