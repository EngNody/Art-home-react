                  ...
                  <div className="wrapper">
                    <div className="breadcrumb">
                      <ul className="flexitem">
                        ...
                        <li>foot and hand Slip On Shoes Casual with Arch Support Insoles</li>
                      </ul>
                    </div>
                              ...
                              <div className="big-image">
                                <div className="big-image-wrapper swiper-wrapper">
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/hand.jpg"><img src="images/hand.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/foot.jpg"><img src="images/foot.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/hand1.jpg"><img src="images/hand1.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/foot1.jpg"><img src="images/foot1.jpg" alt="" /></a>
                                  </div>
                                </div>
                              ...
                              <div style={{height: 0}}>
                                <div style={{height: 0}}>
                                  <a href="#" style={{height: 0}}>
                                    <img src="images/hand2.jpg" alt="" width={0} height={0} />
                                  </a>
                                </div>
                              </div>
      ...
      <li>Fashion Personality</li>
            ...
            <div className="search-buttom desktop-hide">
              <div className="container">
                <div className="wrapper">
                  <form action className="search">
                    <a href="#" className="t-close search-close flexcenter">            <span style={{fontSize: '20px'}}>✖</span></a>
                    <span className="icon-large"><span className="icon-search" /></span>
