                  ...
                  <div className="wrapper">
                    <div className="breadcrumb">
                      <ul className="flexitem">
                        <li><a href="#&quot;">Home</a></li>
                        <li><a href="#&quot;">Hair</a></li>
                        <li>Hair Slip On Shoes Casual with Arch Support Insoles</li>
                      </ul>
                    </div>
                              ...
                              <div className="big-image">
                                <div className="big-image-wrapper swiper-wrapper">
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/hair.jpg"><img src="images/hair.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/hair2.jpg"><img src="images/hair2.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/hair3.jpg"><img src="images/hair3.jpg" alt="" /></a>
                                  </div>
                                  <div className="image-show swiper-slide">
                                    <a data-fslightbox href="images/hair4.jpg"><img src="images/hair4.jpg" alt="" /></a>
                                  </div>
                                </div>
                              ...
                              <div style={{height: 0}}>
                                <div style={{height: 0}}>
                                  <a href="#" style={{height: 0}}>
                                    <img src="images/hair5.jpg" alt="" width={0} height={0} />
                                  </a>
                                </div>
                              </div>
                              <h3 className="ourname" style={{fontSize: '30px'}}>hair Slip On Shoes Casual with Arch Support Insoles</h3><br />
                              <div className="content">
